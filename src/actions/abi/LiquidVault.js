const abi = [
  ...
  },
  {
    ...
    name: "config",
    outputs: [
      { internalType: "address", name: "hardcoreToken", type: "address" },
      {
      ...
      { internalType: "uint32", name: "stakeDuration", type: "uint32" },
      { internalType: "uint8", name: "donationShare", type: "uint8" },
      { internalType: "uint8", name: "purchaseFee", type: "uint8" },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: "uint8", name: "donationShare", type: "uint8" },
      { internalType: "uint8", name: "purchaseFee", type: "uint8" },
      { internalType: "address", name: "uniswapOracle", type: "address" },
    ],
    name: "seed",
    outputs: [],
    stateMutability: "nonpayable",
